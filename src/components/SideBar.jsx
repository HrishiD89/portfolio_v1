...
const SideBar = ({ setToggleSideBar }) => {
  ...
  return (
    <div className="text-black bg-gray-100 py-6 overflow-hidden w-4/5 min-h-screen fixed top-0 left-0 z-[99] inline-block sm:hidden">
      ...
      <ul className="flex flex-col transition-all ">
        <div className="text-5xl py-4  border-t-2 px-6 ">
          <a className="hover:italic hover:translate-x-4 text-yellow-500" href="#home" onClick={handleToggle}>
            Home
          </a>
        </div>
        <div className="text-4xl py-4 px-6 border-t-2 ">
          <a className="hover:italic hover:translate-x-4" href="#about" onClick={handleToggle}>
            About me{" "}
          </a>
        </div>
        <div className="text-4xl py-4 border-t-2 px-6 ">
          <a className="hover:italic hover:translate-x-4" href="#work" onClick={handleToggle}>
            Work
          </a>
        </div>

        <div className="text-4xl py-4 border-y-2 px-6 ">
          <a className="hover:italic hover:translate-x-4" href="#contact" onClick={handleToggle}>
            Contact
          </a>
        </div>
      </ul>
